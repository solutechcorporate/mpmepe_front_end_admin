        ...
        <div class="col-md-6 col-xl-3">
            <div class="card bg-c-blue order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Documents</h6>
                    <h2 class="text-right"><i class="ti-shopping-cart f-left"></i><span>486</span></h2>
                    <p class="m-b-0">Documents disponible<span class="f-right"></span></p>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card bg-c-green order-card">
                <div class="card-block">
                    ...
                    <p class="m-b-0">Articles disponible<span class="f-right"></span></p>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card bg-c-yellow order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Structures</h6>
                    <h2 class="text-right"><i class="ti-reload f-left"></i><span>42,562</span></h2>
                    <p class="m-b-0">Structures disponible<span class="f-right"></span></p>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card bg-c-pink order-card">
                <div class="card-block">
                    ...
                    <p class="m-b-0">Type de demandes<span class="f-right">$542</span></p>
                </div>
            </div>
        </div>
        {/* <!-- order-card end --> */}
                ...
                <div class="card-block">
                    <ul class="feed-blog">
                        ...
                        <li class="diactive-feed">
                            ...
                            <p class="m-b-15 m-t-15"> <b> @everone</b> Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        </li>
                        <li class="active-feed">
                            <div class="feed-user-img">
                                <img src="assets/images/avatar-3.jpg" class="img-radius " alt="User-Profile-Image"/>
